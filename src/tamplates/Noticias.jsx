                ...
                <div className="col-md-6">
                    <div className="card flex-md-row mb-4 box-shadow h-md-250">
                        <div className="card-body d-flex flex-column align-items-start">
                            ...
                            <h3 className="mb-0">
                                <Link className="text-dark" href="#">Featured post</Link>
                            </h3>
                ...
                <div className="col-md-6">
                    <div className="card flex-md-row mb-4 box-shadow h-md-250">
                        <div className="card-body d-flex flex-column align-items-start">
                            ...
                            <h3 className="mb-0">
                                <Link className="text-dark" href="#">Post title</Link>
                            </h3>
                ...
                <div className="row">
                    <div className="col-md-8 blog-main">
                        ...
                        <div className="blog-post">
                            ...
                            <p className="blog-post-meta">December 23, 2013 by <Link href="#">Jacob</Link></p>
                            <p>Cum sociis natoque penatibus et magnis <Link href="#">dis parturient montes</Link>, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum.</p>
                            <blockquote>
                                <p>Curabitur blandit tempus porttitor. <strong>Nullam quis risus eget urna mollis</strong> ornare vel eu leo. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                            </blockquote>
                        ...
                        <div className="blog-post">
                            ...
                            <p className="blog-post-meta">December 14, 2013 by <Link href="#">Chris</Link></p>
                        ...
                        <nav className="blog-pagination mr-2">
                            ...
                            <Link className="btn btn-outline-secondary disabled" href="#">Newer</Link>
                        </nav>
                    </div>
